...
class Dynamixel_XW430_T200_interface(Node):
    ...
    def __init__(self):
        ...
        # 9.6 Mbps is the maximum stable baudrate for X-Series servos
        ...
        self.joint_sub = self.create_subscription(
            Float32MultiArray, 'joint_cmd', self.ros_cb, 1
        )

        # Updated to 0.002 (500Hz) for bus stability at high speeds
        self.control_timer = self.create_timer(0.002, self.hardware_loop)
        self.get_logger().info("XW430 Interface Node Online (9.6 Mbps @ 500Hz).")
